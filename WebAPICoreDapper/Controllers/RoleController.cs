    ...
    public class RoleController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                var result = await conn.QueryAsync<AppRole>("Get_All_Role", paramaters, null, null, System.Data.CommandType.StoredProcedure);
                return Ok(result);
            }
        }
        ...
        public async Task<IActionResult> GetPaging(string keyword, int pageIndex, int pageSize)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                var result = await conn.QueryAsync<AppRole>("Get_Roll_AllPaging", paramaters, null, null, System.Data.CommandType.StoredProcedure);
